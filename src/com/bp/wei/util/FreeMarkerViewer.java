...
public class FreeMarkerViewer extends FreeMarkerView {
	private static Logger log = LoggerFactory.getLogger(FreeMarkerViewer.class);
	@Override
    protected void doRender(Map<String, Object> model, HttpServletRequest request, HttpServletResponse response)
        ...
        log.debug("Rendering FreeMarker 模版 [" + getUrl() + "] in FreeMarkerView '" + getBeanName() + "'");
    ...
    public void createHTML(Template template, SimpleHash model, HttpServletRequest request,
        ...
        System.out.println("Page's absolute path ===========>>:"+htmlPath);
